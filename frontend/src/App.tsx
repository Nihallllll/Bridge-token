...
import { SEPOLIA_BRIDGE ,SEPOLIA_TOKEN ,HOLESKY_BRIDGE ,HOLESKY_TOKEN ,TOKEN_ALLOWANCE_ABI ,abi } from './utils/abi'
...
export function App() {
   const [fromNetwork, setFromNetwork] = useState('HOLESKY');
  ...
  useEffect(() => {
    ...
    if (chainId === 56) {
      ...
      setToNetwork('HOLESKY')
      setTokenAddress(SEPOLIA_TOKEN);
      setSpenderAddress(SEPOLIA_BRIDGE);
    } else if (chainId === 43113) {
      setFromNetwork('HOLESKY')
      setToNetwork('SEPOLIA')
      setTokenAddress(HOLESKY_TOKEN);
      setSpenderAddress(HOLESKY_BRIDGE);
    } else {
      setFromNetwork('SEPOLIA')
      setToNetwork('HOLESKY')
      setTokenAddress(SEPOLIA_TOKEN);
